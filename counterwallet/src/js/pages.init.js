...
function initBalances() {
  ...
  window.ENHANCED_BROADCAST_MODAL = new EnhancedBroadcastModalViewModel();
  ...
  ko.applyBindings(ENHANCED_BROADCAST_MODAL, document.getElementById("enhancedBroadcastModal"));
